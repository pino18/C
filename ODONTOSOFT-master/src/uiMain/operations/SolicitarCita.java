...
public class SolicitarCita extends OpcionDeMenu {//El metodo solicitar cita hace reservación de citas dada su fecha y hora, hace revisión de la disponibilidad de horario para la cita solicitada, dado que si hay una cita agendada para una fecha y hora especifica no puedan haber repeticiones
